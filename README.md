...
- [Inference over Carabid dataset](https://colab.research.google.com/drive/1lhOWyEJ9Y9N2nN4qeGGJ5_ISNnAHv8Bm#scrollTo=AE-q04b3Fvee) --> Works great on the training set. So-so performance on images from the wild.
---
